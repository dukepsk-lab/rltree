...
# NOTE: rl_model_h12.zip was trained on the legacy TradingEnv (long-only,
...
LOT_SIZE = 0.01
WINDOW_SIZE = 20
TP_PRICE_DIFF = 3.00   # must match TP_PRICE_DIFF in rl_train_h12.py
...
def main():
    ...
    try:
        model = PPO.load(os.path.join(BASE_DIR, "rl_model_h12"))
        scaler = joblib.load(os.path.join(BASE_DIR, "rl_scaler_h12.save"))
